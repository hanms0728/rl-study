...
def main(gamma: float | None = None, noise: float | None = None,
    ...
    vq_path = viz.figure_path("07_v_and_q", g=gamma, n=noise, s=step_reward)
    viz.figure_v_and_q(
    ...
    noise_path = viz.figure_path("09_noise_sweep_q", g=gamma, s=step_reward)
    viz.figure_q_panels(
        gw.main_grid(step_reward=step_reward), q_panels, noise_path, ncols=3,
